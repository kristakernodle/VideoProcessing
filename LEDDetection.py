...
cap = cv2.VideoCapture('/SharedX/Neuro-Leventhal/data/mouseSkilledReaching/et740/Training/et740_20181212_CC2_T13/'+filename+'.MP4')
...
file=open('/media/kkrista/KRISTAEHD/Python_LEDDetection/'+filename+'.txt','w+')
